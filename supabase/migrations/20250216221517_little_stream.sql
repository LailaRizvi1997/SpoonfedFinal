-- Create list_favorites table if it doesn't exist
...
DO $$ 
BEGIN
  DROP POLICY IF EXISTS "Anyone can view list favorites" ON list_favorites;
  DROP POLICY IF EXISTS "Users can manage own list favorites" ON list_favorites;
EXCEPTION
