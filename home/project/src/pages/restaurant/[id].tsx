...
export default function RestaurantProfilePage() {
  ...
  // Load restaurant data when id changes
  useEffect(() => {
  ...
  const loadRestaurant = async () => {
    ...
    try {
      ...
      // Transform restaurant data to ensure numbers are numbers
      const transformedRestaurant: Restaurant = {
        ...
        review_count:
          typeof restaurantData.review_count === "object"
            ? restaurantData.review_count.count
            : Number(restaurantData.review_count) || 0,
      ...
      // Fetch reviews (we assume likes_count is not stored, so we set it to 0)
      ...
      const transformedReviews = (reviewsData || []).map((review) => ({
        ...
        tag: review.tag,
        user: {
          username: review.users?.username || "Unknown User",
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {/* Here you could add sorting & filtering controls if desired */}
              {reviews.length === 0 ? (
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {review.tag && (
                            <Badge variant="secondary">{review.tag}</Badge>
                          )}
